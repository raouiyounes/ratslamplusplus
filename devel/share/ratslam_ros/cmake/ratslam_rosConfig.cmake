...
if(NOT "/home/younes/eclipse-workspace/Hamburg_Lim/devel/include " STREQUAL " ")
  set(ratslam_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/younes/eclipse-workspace/Hamburg_Lim/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ratslam_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/younes/eclipse-workspace/Hamburg_Lim/src/ratslam_python/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/younes/eclipse-workspace/Hamburg_Lim/devel/lib;/home/younes/eclipse-workspace/Hamburg/devel/lib;/opt/ros/kinetic/lib)
